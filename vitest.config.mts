  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/database/typeorm-transaction-scope.ts',
        'src/database/typeorm-unit-of-work.adapter.ts',
        ...
        'src/core/health/readiness.service.ts',

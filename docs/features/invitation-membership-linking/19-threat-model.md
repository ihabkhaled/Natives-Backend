...
| #   | Threat                                                                 | Assessment                                                                                                                                                                                                 |
| --- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T1  | Reconciliation attaches an account to the wrong person's roster record | The real risk. Mitigated by acting only when a team holds exactly one invited, unlinked, email-less candidate; anything else is reported and skipped. Dry run is the default                               |
...
T1 is reduced, not eliminated: a team with exactly one email-less candidate that
is genuinely a different person would be matched. Accepted because the dry run
is reviewed by a human before `--apply`, and every link is auditable and

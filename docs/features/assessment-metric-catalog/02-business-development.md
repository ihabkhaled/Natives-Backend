...
The catalog enables consistent player development programs and defensible performance reporting
without introducing a new commercial SLA or external vendor. Initial rollout is to team
administrators and coaches; players consume published assessment results in later prompts.

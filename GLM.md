# GLM.md — IronNest Backend Agent Entrypoint

> This is the GLM-family agent entrypoint for the IronNest repository. Read this file first, then `claude.md` as the canonical long-form operating policy. If this file ever contradicts `claude.md`, `claude.md` wins unless this file is temporarily stricter for safety.
...
1. `GLM.md` (this entrypoint) — how GLM agents bootstrap for this repo.

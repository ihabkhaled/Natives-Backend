# KIMI.md — IronNest Backend Agent Entrypoint

> This is the Kimi-family agent entrypoint for the IronNest repository. Read this file first, then `claude.md` as the canonical long-form operating policy. If this file ever contradicts `claude.md`, `claude.md` wins unless this file is temporarily stricter for safety.
...
1. `KIMI.md` (this entrypoint) — how Kimi agents bootstrap for this repo.

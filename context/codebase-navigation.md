...
> Your fastest path from a task to the right layer, files, rule, and skill. `claude.md` wins globally; within subordinate engineering guidance, [architecture-map.md](./architecture-map.md), [stack-and-toolchain.md](./stack-and-toolchain.md), and [rule 00](../rules/00-non-negotiable-rules.md) decide.
...
| Add or move a type / interface / enum / constant | `model/`, `api/dto/`, `lib/`, `domain/`, `core/`, `config/`, or `shared/` via the ownership map | [06](../rules/06-types-enums-constants.md), [30](../rules/30-declaration-ownership.md)                | [extract-constants-types-enums.md](../skills/extract-constants-types-enums.md), [refactor-inline-declarations.md](../skills/refactor-inline-declarations.md) |
...
| Task                                     | Layer & files to open                                             | Rule(s)                                            | Skill                                                                |
| ---------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------- | -------------------------------------------------------------------- |
| Protect a route / add a permission       | `core/auth/` guard/decorator + application/domain ownership scope | [07](../rules/07-security-authn-authz.md)          | [add-guard-and-permission.md](../skills/add-guard-and-permission.md) |
...
| Decompose a god-file / long method                 | the offending layer file → extract to `lib/`, `domain/`, `model/`                                                           | [01](../rules/01-architecture-and-module-boundaries.md), [23](../rules/23-function-service-file-size-discipline.md)                             | [decompose-large-file.md](../skills/decompose-large-file.md), [split-large-service.md](../skills/split-large-service.md), [split-large-use-case.md](../skills/split-large-use-case.md), [split-large-repository.md](../skills/split-large-repository.md) |
| Simplify overbuilt / clever code                   | the offending file → [simple-code-map.md](./simple-code-map.md) routes it                                                   | [20](../rules/20-simple-readable-code.md), [21](../rules/21-yagni-and-minimalism.md)                                                            | [simplify-existing-code.md](../skills/simplify-existing-code.md), [refactor-smart-code-to-boring-code.md](../skills/refactor-smart-code-to-boring-code.md), [remove-unnecessary-code.md](../skills/remove-unnecessary-code.md)                           |
| Review a diff for readability                      | the diff, read as the next maintainer                                                                                       | [24](../rules/24-team-readable-code-review.md)                                                                                                  | [review-for-readable-code.md](../skills/review-for-readable-code.md)                                                                                                                                                                                     |
| Run a full repository cleanup                      | [refactor-navigation.md](./refactor-navigation.md) plus every affected flow                                                 | [28](../rules/28-codebase-refactor-discipline.md), [30](../rules/30-declaration-ownership.md)                                                   | [full-codebase-cleanup.md](../skills/full-codebase-cleanup.md)                                                                                                                                                                                           |
| Refactor security/validation code                  | [security-clean-code-map.md](./security-clean-code-map.md) / [validation-clean-code-map.md](./validation-clean-code-map.md) | [07](../rules/07-security-authn-authz.md), [05](../rules/05-dto-and-validation.md)                                                              | [cleanup-security-code-without-weakening.md](../skills/cleanup-security-code-without-weakening.md), [cleanup-validation-code-without-weakening.md](../skills/cleanup-validation-code-without-weakening.md)                                               |
| Update agent mirrors/entrypoints                   | [agent-readiness-map.md](./agent-readiness-map.md)                                                                          | [29](../rules/29-agent-readiness-and-mirrors.md)                                                                                                | [prepare-agent-mirrors.md](../skills/prepare-agent-mirrors.md)                                                                                                                                                                                           |
...
| Resolve context for a task (compiled)              | run `npm run knowledge:context -- --task="…"` → read `.ai/local/current-context.md`                                         | —                                                                                                                                               | [tools/knowledge/README.md](../tools/knowledge/README.md)                                                                                                                                                                                                |
| Change an API/event/schema/config/adapter contract | [contracts-map.md](./contracts-map.md) routes to the owner                                                                  | [05](../rules/05-dto-and-validation.md), [17](../rules/17-configuration-and-environment.md), [12](../rules/12-library-wrapping-and-adapters.md) | the owner rule's skill (e.g. [create-dto-validation.md](../skills/create-dto-validation.md), [add-config-value.md](../skills/add-config-value.md), [add-library-adapter.md](../skills/add-library-adapter.md))                                           |
...
| Feature vendor integration                            | `adapters/<vendor>.adapter.ts` behind a model/core port                  |
| Module-local types                                    | `model/<feature>.types.ts`                                               |
| Module-local interfaces (when intentionally separate) | `model/<feature>.interfaces.ts`                                          |
...
| Auth / permission guards and identity/decorators                       | `src/core/auth/`                                                                            |
| Interceptors (logging, timeout, response shaping)                      | `src/core/interceptors/`                                                                    |
| Custom pipes (e.g. Zod validation pipe)                                | `src/core/pipes/`                                                                           |
| Auth param/metadata decorators (`@CurrentUser`, `@RequirePermissions`) | `src/core/auth/`                                                                            |

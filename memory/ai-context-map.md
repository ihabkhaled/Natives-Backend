...
| Resolve context for a task (the mandatory first step) | —                                                                                                                                 | [resolve-task-context.md](../skills/resolve-task-context.md) — run `npm run knowledge:context -- --task="…"`; read `.ai/local/current-context.md` (see [tools/knowledge](../tools/knowledge))                                    |

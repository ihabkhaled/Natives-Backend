...
| File                                                                     | Holds                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`backend-stack.md`](./backend-stack.md)                                 | The exact runtime, framework version, ORM choice, validator choice, and every `package.json` script with what it does. Records the Husky gates, TypeScript 7 CLI / TypeScript 6 compatibility-API ownership, Vitest, and the project's chosen ORM.                                                                                                                     |
...
| [`privacy-decisions.md`](./privacy-decisions.md)                         | What personal data this reference backend actually processes (auth credentials only), why most privacy-program sections are not applicable, and where a real project fills them in. Points at [`security-decisions.md`](./security-decisions.md) and [`observability-decisions.md`](./observability-decisions.md) for the shared enforcement paths.                    |
| [`operations-decisions.md`](./operations-decisions.md)                   | The operational model this repo has (health/readiness/graceful-shutdown wired deployment-agnostically) and where deployment topology, scaling, IaC, and SLOs are not applicable yet. Points at [`release-checklist.md`](./release-checklist.md) and [`/runbooks`](../runbooks/README.md) for procedures.                                                               |
...
| [`code-simplicity-decisions.md`](./code-simplicity-decisions.md)         | Why simple readable code is permanent policy: the Simple Code Ladder, minimum-safe-code, no clever TypeScript, no speculative abstraction, reuse-before-create, helper/declaration ownership, and no token-burning output. Backs [`/rules/20`](../rules/20-simple-readable-code.md)–[`30`](../rules/30-declaration-ownership.md) (rules 43–50).                        |
| [`refactor-decisions.md`](./refactor-decisions.md)                       | Responsibility-sliced refactors, characterization tests, complete declaration migrations, and non-random splitting.                                                                                                                                                                                                                                                    |
| [`agent-readiness-decisions.md`](./agent-readiness-decisions.md)         | Canonical/mirror roles, why `codex.md` fulfills the GPT full mirror, compact entrypoints, and synchronization expectations.                                                                                                                                                                                                                                            |
| [`security-refactor-decisions.md`](./security-refactor-decisions.md)     | Security-safe cleanup: vendor ports, central permissions, owner scoping before pagination, typed/redacted failures.                                                                                                                                                                                                                                                    |
| [`validation-refactor-decisions.md`](./validation-refactor-decisions.md) | Validation-safe cleanup: DTO declarations, one validation owner, complete fail-fast env validation, safe observable errors.                                                                                                                                                                                                                                            |
